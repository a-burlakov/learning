    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tagline",
                    models.CharField(default="", max_length=150, verbose_name="Слоган"),
                ),
                ("description", models.TextField(verbose_name="Описание")),
                (
                    "poster",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=2023, verbose_name="Год выхода"
                    ),
                ),
                ...
                (
                    "world_premiere",
                    models.DateField(
                        default=datetime.date.today, verbose_name="Премьера в мире"
                    ),
                ),
                (
                    "budget",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="указывать суму в долларах",
                ...
                (
                    "genres",
                    models.ManyToManyField(to="movies.genre", verbose_name="жанры"),
                ),
            ],
            options={
                "verbose_name": "Фильм",
